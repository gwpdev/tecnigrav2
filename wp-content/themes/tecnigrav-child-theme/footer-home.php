<video style="z-index: 0" autoplay="autoplay" loop="loop" width="100%" height="auto">' + 
 '<source type="video/mp4" src="http://wellelaser.com/vids/welle_t.mp4" />' + 
 '<source type="video/mp4" src="http://wellelaser.com/vids/welle_t.webm" />' + 
 '<source type="video/mp4" src="http://wellelaser.com/vids/welle_t.ogv" />' + 
'</video>
<div class="clear"></div>
